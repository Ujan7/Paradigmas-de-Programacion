...
public class JSONParser {
    ...
    public static Location parseLocInfo(JSONObject info, String label, List<String> topics) {
        ...
        Double latitudeDouble = location.getDouble("lat");
        Double longitudeDouble = location.getDouble("lon");
        Double temperatureDouble = current.getDouble("temp_c");
    
        Float latitude = latitudeDouble.floatValue();
        Float longitude = longitudeDouble.floatValue();
        Float temperature = temperatureDouble.floatValue();
